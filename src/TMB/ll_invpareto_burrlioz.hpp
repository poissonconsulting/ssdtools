...
// We are using the Pareto distribution as coded in Burrlioz
...
// You will need to either fix the scale parameter or maximize over both. 
// In both cases the hessian is not useful for finding standard errors.
...
#ifndef ll_invpareto_burrlioz_hpp
#define ll_invpareto_burrlioz_hpp

#undef TMB_OBJECTIVE_PTR
#define TMB_OBJECTIVE_PTR obj

template<class Type>
Type ll_invpareto_burrlioz(objective_function<Type>* obj) // normal with parameters mu and log(sigma)
{
  // Data
