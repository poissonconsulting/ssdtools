...
[`?ssd_gof`](https://bcgov.github.io/ssdtools/dev/reference/ssd_gof.md)
...
[`ssd_plot_cdf()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_plot_cdf.md)).
...
Note if
[`ssd_gof()`](https://bcgov.github.io/ssdtools/dev/reference/ssd_gof.md)
is called with `pvalue = TRUE` then the p-values rather than the
statistics are returned for the ad, ks and cvm tests.
