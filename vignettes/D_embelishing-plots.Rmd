---
title: "Embellishing Plots"
author: "ssdtools Team"
date: '`r format(Sys.time(), "%Y-%m-%d")`'
bibliography: references.bib
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Embellishing Plots}
...
The `ssdtools` package produces a plot of the cumulative distributions for the multiple input distributions through the use of the `ssd_plot_cdf()` function. 
