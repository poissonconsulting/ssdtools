...
Burrlioz 2.0 uses a non-parametric bootstrap method to obtain confidence intervals on the *HCx*
...
by calculating the lower 0.025th and upper 0.975th quantiles of the resulting *HCx* estimates across all56
...
calculated as the lower 0.025th and upper 0.975th quantiles of the resulting *HCx* estimates across all the
