...
As with the North American `invpareto`, the European `invpareto_eur` is offered as a user-selectable distribution but is not included in the default candidate set and must be fitted in isolation rather than as part of a model-averaged set.
