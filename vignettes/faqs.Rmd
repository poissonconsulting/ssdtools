...
### How can I select a subset of the fitted distributions?

Use the `[` operator with the distribution names (or their positions) to get a `fitdists` object with just those distributions.
